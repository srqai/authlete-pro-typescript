...
export interface Env {
  AUTHELETEPRO_API_KEY?: string | undefined;

  AUTHELETEPRO_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  AUTHELETEPRO_API_KEY: z.string().optional(),

  AUTHELETEPRO_DEBUG: z.coerce.boolean().optional(),
});
